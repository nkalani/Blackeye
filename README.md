...
####  FOR ANY SUGGESTION CONTACT :@navneethkalani on Instagram!
...
###   Contact me on Instagram : @navneethkalani for the Pro Version

-----------------------------------------------------------------------------------------------------------------------------

## BLACKEYE v1.0
### Coded by: @thelinuxchoice (https://github.com/thelinuxchoice/blackeye)
### Upgraded by: @nkalani (https://github.com/nkalani/blackeye)
...
#### Phishing Pages generated by @nkalani (https://github.com/nkalani/blackeye):
...
### Usage:
```
git clone https://github.com/nkalani/blackeye
cd blackeye
bash blackeye.sh
```